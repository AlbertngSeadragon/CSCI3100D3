...
@Component({
  selector: 'app-nonvp-bar-chart',
  templateUrl: './nonvp-bar-chart.component.html',
  styleUrls: ['./nonvp-bar-chart.component.scss']
})
export class NonvpBarChartComponent implements OnInit {
